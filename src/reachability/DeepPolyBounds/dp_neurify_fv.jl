...
@with_kw struct DPNeurifyFV <: Solver
...
function forward_linear(solver::DPNeurifyFV, L::LayerNegPosIdx, input::SymbolicIntervalFVHeur)
...
function forward_act(solver::DPNeurifyFV, L::LayerNegPosIdx{ReLU}, input::SymbolicIntervalFVHeur)
    n_node = n_nodes(L)
